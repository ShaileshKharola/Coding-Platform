                ...
                <div className='px-5'>
                    <div className='w-full'>
                        ...
                        <div className='flex item-center mt-3'>
                            ...
                            <div className='rounded p-[3px] ml-4 text-lg transition-colors duration-200 text-gree-s text-green-700'></div>
                            <BsCheck2Circle/>
                        </div>
                        ...
                        <div className='cursor-pointer hover:bg-gray-100 rounded p-[3px] ml-4 text-xl transition-colors duration-200 text-green-100 text-gray-400'>
                            <TiStarOutline/>
                        </div>
                    </div>
                    ...
                    <div className='mt-4'>
                        <div><p className='font-medium text-white'>Example 1:</p>
                        <div className='example-card'>
                            <pre> <strong className='text white'>Input:</strong>nums = [2,7,11,15], target = 9{" "}
                            <br/>
                    ...
                    <div>
                        ...
                        <div className='example-card'>
                            <pre> <strong className='text white'>Input:</strong>nums = [3,2,4], target = 6{" "}
                            <br/>
                    ...
                    <div>
                        ...
                        <div className='example-card'>
                            <pre> <strong className='text white'>Input:</strong>nums = [3,3], target = 6{" "}
                            <br/>
                            <strong>Output:</strong>[0,1] <br />
