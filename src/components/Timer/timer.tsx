...
const Timer: React.FC<TimerProps> = () => {
	...
	return (
		<div>
			{showTimer ? (
				<div className='flex items-center space-x-2 bg-gray-300 py-1.5 cursor-pointer rounded hover:bg-dark-fill-2'>
				...
				>
					<Image src="/time.png" alt="timer"
						width={35} height={35} className="bg-gray-300 p-1 h-8 rounded hover:bg-gray-200 transition duration-300 cursor-pointer"/>
						<path
							fillRule='evenodd'
